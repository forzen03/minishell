...
int					check_redirection_in_out(char *line, int *i, t_token *node,
						t_token **tokens);
...
void				handle_quoted_words(char *line, int *i, t_token **tokens,
						t_token *node);
...
void				expander_rebuild_argv_and_expand_redirections(t_cmd *tmp,
						t_cmd *cmds, t_list *env);
...
int					handle_heredoc_line(t_heredoc_line_data *data, int write_fd,
						char *line);
